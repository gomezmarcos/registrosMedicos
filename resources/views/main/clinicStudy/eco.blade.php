<div id="eco" class="tab-pane fade">
  ...
  <input type="hidden" name="_method" value="put" />
      <h3>Ecografias</h3>
      <div class="alert alert-info text-center" >Aqui puede cargar todos sus estudios de Ecografias. Es una manera facil de mantener organizada sus estudios y que sean de facil acceso al buscarlos.</div>

    <div class="col-md-12">
        <div class="row">
        <button class="btn btn-primary btn-create-eco-data" id="btnNewEco">Nuevo Estudio</button>
        </div>
        <div class="row">
