                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/registration/store') }}">
                        ...
                        <div class="form-group{{ $errors->has('names') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="names" type="text" class="form-control" name="names" value="{{ old('names') }}">
                        ...
                        <div class="form-group{{ $errors->has('dni') ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4 control-label">Documento de Identidad</label>

                            <div class="col-md-6">
                                <input id="dni" type="dni" class="form-control" name="dni" value="{{ old('dni') }}">
