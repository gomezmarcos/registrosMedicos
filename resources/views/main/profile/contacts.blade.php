<div id="contacts" class="tab-pane fade">
  ...
  <input type="hidden" name="_method" value="put" />
    ...
    <div class="col-md-12">
        ...
        <div class="form-group col-md-4">
              <label for="link1" class="control-label">Relacion</label>
    ...
    <div class="col-md-12">
        ...
        <div class="form-group col-md-4">
              <label for="link2" class="control-label">Relacion</label>
    ...
    <div class="col-md-12">
        ...
        <div class="form-group col-md-4">
              <label for="link3" class="control-label">Relacion</label>
              <input type="text" name="link3" class="form-control" 
                value="{{ $pc->link3 or '' }}"> 
        </div>        
        
        <div class="form-group col-md-4">
              <label for="contact3" class="control-label">Telefono o Mail</label>
